...
const translations = {
    "zh-TW": {
        ...
        nav_video_queue: "Video Gen Queue",
        nav_features: "專業功能",
        nav_pricing: "終身授權",
        nav_faq: "常見問題",
        nav_cta: "獲取 PRO 授權",
        ...
        // Hero Section (v2.2)
        hero_badge: "v2.2 最新更新 | Video Gen Queue・專案式下載・影片工作室",
        hero_title_1: "全自動化 Grok",
        hero_title_2: "媒體資產管理",
        hero_desc: "不只是下載器，更是您的創作工作室。v2.2 全新 Video Gen Queue 自動排程影片生成、Project-Based Download 專案資料夾管理、四種生成模式選擇。讓專業工具接手您的創作流程。",
        hero_cta_primary: "獲取 PRO 終身版",
        hero_cta_secondary: "查看方案與價格",
        hero_cta_chrome: "加到 Chrome",
        hero_trust_1: "安全無毒",
        hero_trust_2: "極速引擎",

        // Video Gen Queue Section (NEW v2.2)
        queue_badge: "v2.2 全新功能",
        queue_title: "Video Gen Queue",
        queue_subtitle: "自動化影片生成排程",
        queue_desc: "全新 Side Panel 介面，一鍵批次加入影片生成佇列。支援 Custom/Normal/Fun/Spicy 四種模式，自動重試失敗任務，智慧偵測速率限制。",
        queue_cta: "了解更多",
        queue_feat_1_title: "自動重試機制",
        queue_feat_1_desc: "生成失敗時自動重新加入佇列，確保每個任務都能完成。",
        queue_feat_2_title: "批次加入佇列",
        queue_feat_2_desc: "從收藏清單一鍵選取多個項目，批量加入生成佇列。",
        queue_feat_3_title: "四種生成模式",
        queue_feat_3_desc: "支援 Custom/Normal/Fun/Spicy 模式，滿足不同創作風格需求。",
        queue_feat_4_title: "速率限制偵測",
        queue_feat_4_desc: "智慧偵測 Grok API 速率限制，自動暫停並在冷卻後恢復。",

        // Video Gen Queue Demo & Detail Page
        queue_demo_caption: "* 影片展示 Video Gen Queue 的完整自動化流程",
        queue_page_desc: "全新 Side Panel 介面，一鍵批次加入影片生成佇列。支援四種生成模式、自動重試失敗任務、智慧偵測速率限制，讓影片生成完全自動化。",
        queue_video_title: "完整工作流程展示",
        queue_video_desc: "從加入佇列 → 設定參數 → 自動生成 → 完成收集",
        queue_video_caption: "* 影片展示 Video Gen Queue 的完整使用流程",
        queue_core_title: "核心功能",
        queue_core_desc: "Video Gen Queue 提供完整的自動化影片生成工具鏈",
        queue_step_title: "Video Gen Queue 使用流程",
        queue_step_desc: "五個簡單步驟，自動化您的影片生成流程",
        queue_step_1_title: "瀏覽 Grok Imagine",
        queue_step_1_desc: "在 grok.com 瀏覽或產生圖片，找到想要生成影片的 Posts。",
        queue_step_2_title: "加入佇列",
        queue_step_2_desc: "點擊浮動 🎯 按鈕或使用批次加入功能，選取時間範圍(1h~72h)一鍵加入近期 Posts。",
        queue_step_3_title: "設定參數",
        queue_step_3_desc: "選擇模式(Custom/Normal/Fun/Spicy)、時長(6s/10s)、解析度(480p/720p)、目標次數與重試上限。",
        queue_step_4_title: "開始生成",
        queue_step_4_desc: "點擊 Start，系統自動依序導航至各 Post 頁面並提交生成請求。",
        queue_step_5_title: "完成收集",
        queue_step_5_desc: "成功生成的影片自動出現在您的 Grok 收藏中，隨時可下載。",
        queue_tech_title: "技術亮點",
        queue_tech_1_title: "Chrome Side Panel API",
        queue_tech_1_desc: "採用 Chrome 最新 Side Panel API，提供常駐式工作區，不干擾主頁面瀏覽。",
        queue_tech_2_title: "IndexedDB 持久化",
        queue_tech_2_desc: "佇列資料與提示詞統計獨立儲存於 IndexedDB，關閉瀏覽器後資料不遺失。",
        queue_tech_3_title: "Fetch Interceptor",
        queue_tech_3_desc: "MAIN world 攔截生成結果，搭配 90 秒超時回退機制，確保每次生成都能正確追蹤。",
        queue_tech_4_title: "Free/Pro 分級",
        queue_tech_4_desc: "免費用戶可使用 50 次，PRO 用戶無上限，滿足不同使用需求。",
        queue_cta_start: "開始自動化影片生成",

        // Story Mode Helper Section
        story_badge: "PRO 功能",
        ...
        feat_1_desc: "無需手動逐一尋找。Extension 會自動掃描您收藏的圖片與影片，智慧生成所有可下載的媒體清單。",
        ...
        feat_8_title: "Video Gen Queue (PRO)",
        feat_8_desc: "自動化影片生成排程！批次加入佇列、四種生成模式、自動重試、速率限制偵測。免費版 50 次，PRO 無限制。",
        feat_9_title: "Project-Based Download (PRO)",
        feat_9_desc: "專案式資料夾管理！下載前自動掃描統計、依日期與提示詞建立專案資料夾，檔案分類一目了然。",
        ...
        solution_3_title: "影片創作全自動化",
        solution_3_desc: "v2.2 Video Gen Queue 自動排程生成、Story Mode 編排合併、Project Download 專案管理，一站式完成。",
        ...
        cross_link_queue: "探索另一個強大功能：Video Gen Queue →",
        cross_link_story: "探索另一個強大功能：Story Mode Helper →",
        ...
        price_feat_9: "Video Gen Queue (影片生成排程)",
        price_feat_10: "Project-Based Download (專案資料夾)",
        price_cta: "立即啟用 PRO",
        price_promo_badge: "v2.2 限時優惠 ~ 3/10",
        price_pro_button: "$4.99 → $2.99 PRO 終身版",
        ...
        faq_12_q: "什麼是 Video Gen Queue？",
        faq_12_a: "Video Gen Queue 是 v2.2 的全新功能。它是一個自動化影片生成排程系統，可在 Side Panel 中批次加入多個影片生成任務，支援 Custom/Normal/Fun/Spicy 四種模式。免費版提供 50 次使用，PRO 版無限制。",
        faq_13_q: "什麼是 Project-Based Download？",
        faq_13_a: "Project-Based Download 會在下載前自動掃描統計（圖片/影片數量、HD/SD 比例），並依日期與提示詞自動建立專案資料夾（格式：{日期}_{提示詞}/），讓您的下載檔案分類井然有序。此功能為 PRO 專屬。",
...
透過 Lemon Squeezy 購買的授權，退款政策依循該平台規範。若遇技術問題無法解決，請聯繫支援團隊。`,
        ...
        // Performance note
        perf_note_title: "v2.2 全新升級：",
        perf_note_desc: "Video Gen Queue 自動排程、Project-Based Download 專案管理、四種生成模式、系統日誌記錄。",
    ...
    "en": {
        ...
        // Hero Section (v2.2)
        hero_badge: "v2.2 Latest Update | Video Gen Queue・Project Download・Video Studio",
        hero_title_1: "Automated Grok",
        hero_title_2: "Media Asset Mgmt",
        hero_desc: "Not just a downloader, but your creative studio. v2.2's new Video Gen Queue automates video generation, Project-Based Download organizes files into project folders, and 4 generation modes fit every style.",
        hero_cta_primary: "Get PRO Lifetime",
        hero_cta_secondary: "View Plans & Pricing",
        hero_cta_chrome: "Add to Chrome",
        hero_trust_1: "Secure & Virus-free",
        hero_trust_2: "Fast Engine",

        // Video Gen Queue Section (NEW v2.2)
        queue_badge: "v2.2 NEW FEATURE",
        queue_title: "Video Gen Queue",
        queue_subtitle: "Automated Video Generation Queue",
        queue_desc: "New Side Panel interface for batch video generation. Supports Custom/Normal/Fun/Spicy modes, auto-retry on failure, and smart rate limit detection.",
        queue_cta: "Learn More",
        queue_feat_1_title: "Auto Retry",
        queue_feat_1_desc: "Failed generations automatically re-queue, ensuring every task completes successfully.",
        queue_feat_2_title: "Batch Add to Queue",
        queue_feat_2_desc: "Select multiple items from favorites and batch add them to the generation queue with one click.",
        queue_feat_3_title: "4 Generation Modes",
        queue_feat_3_desc: "Choose from Custom/Normal/Fun/Spicy modes to match your creative style.",
        queue_feat_4_title: "Rate Limit Detection",
        queue_feat_4_desc: "Smart detection of Grok API rate limits, auto-pause and resume after cooldown.",

        // Video Gen Queue Demo & Detail Page
        queue_demo_caption: "* Video demonstrates the complete Video Gen Queue automation workflow",
        queue_page_desc: "New Side Panel interface for batch video generation. Supports 4 generation modes, auto-retry on failure, and smart rate limit detection for fully automated video generation.",
        queue_video_title: "Complete Workflow Demo",
        queue_video_desc: "Add to Queue → Configure Settings → Auto Generate → Collect Results",
        queue_video_caption: "* Video demonstrates the complete Video Gen Queue workflow",
        queue_core_title: "Core Features",
        queue_core_desc: "Video Gen Queue provides a complete automated video generation toolchain",
        queue_step_title: "How Video Gen Queue Works",
        queue_step_desc: "Five simple steps to automate your video generation workflow",
        queue_step_1_title: "Browse Grok Imagine",
        queue_step_1_desc: "Browse or generate images on grok.com. Find Posts you want to turn into videos.",
        queue_step_2_title: "Add to Queue",
        queue_step_2_desc: "Click the floating 🎯 button or use batch add to select a time range (1h~72h) and add recent Posts with one click.",
        queue_step_3_title: "Configure Settings",
        queue_step_3_desc: "Choose mode (Custom/Normal/Fun/Spicy), duration (6s/10s), resolution (480p/720p), target count, and max retries.",
        queue_step_4_title: "Start Generation",
        queue_step_4_desc: "Click Start. The system automatically navigates to each Post page and submits generation requests in sequence.",
        queue_step_5_title: "Collect Results",
        queue_step_5_desc: "Successfully generated videos automatically appear in your Grok favorites, ready for download anytime.",
        queue_tech_title: "Technical Highlights",
        queue_tech_1_title: "Chrome Side Panel API",
        queue_tech_1_desc: "Uses Chrome's latest Side Panel API for a persistent workspace that doesn't interfere with main page browsing.",
        queue_tech_2_title: "IndexedDB Persistence",
        queue_tech_2_desc: "Queue data and prompt statistics stored independently in IndexedDB. Data persists even after closing the browser.",
        queue_tech_3_title: "Fetch Interceptor",
        queue_tech_3_desc: "MAIN world interception of generation results with 90-second timeout fallback, ensuring accurate tracking of every generation.",
        queue_tech_4_title: "Free/Pro Tiers",
        queue_tech_4_desc: "Free users get 50 uses, PRO users get unlimited access to meet different usage needs.",
        queue_cta_start: "Start Automating Video Generation",

        // Story Mode Helper Section
        story_badge: "PRO Feature",
        story_title: "Story Mode Helper",
        ...
        feat_1_desc: "No more manual searching. The extension automatically scans your favorite images and videos to generate a downloadable media list.",
        ...
        feat_8_title: "Video Gen Queue (PRO)",
        feat_8_desc: "Automated video generation queue! Batch add, 4 generation modes, auto-retry, rate limit detection. Free: 50 uses, PRO: Unlimited.",
        feat_9_title: "Project-Based Download (PRO)",
        feat_9_desc: "Project folder management! Pre-download scanning with stats, auto-create project folders by date and prompt for organized files.",
        ...
        solution_3_title: "Full Video Automation",
        solution_3_desc: "v2.2 Video Gen Queue for auto-scheduling, Story Mode for editing & merging, Project Download for organized management—all in one.",
        ...
        cross_link_queue: "Explore another powerful feature: Video Gen Queue →",
        cross_link_story: "Explore another powerful feature: Story Mode Helper →",
        ...
        price_feat_9: "Video Gen Queue (Auto Generation)",
        price_feat_10: "Project-Based Download (Project Folders)",
        price_cta: "Activate PRO Now",
        price_promo_badge: "v2.2 Limited Offer — Until 3/10",
        price_pro_button: "$4.99 → $2.99 PRO Lifetime",
        ...
        faq_12_q: "What is Video Gen Queue?",
        faq_12_a: "Video Gen Queue is a brand new v2.2 feature. It's an automated video generation scheduling system in the Side Panel. Batch add multiple video generation tasks with Custom/Normal/Fun/Spicy modes. Free version offers 50 uses, PRO is unlimited.",
        faq_13_q: "What is Project-Based Download?",
        faq_13_a: "Project-Based Download scans and shows pre-download stats (image/video counts, HD/SD breakdown), then auto-creates project folders named by date and prompt ({date}_{prompt}/). This keeps your downloads neatly organized. PRO exclusive feature.",
...
Refunds for licenses purchased via Lemon Squeezy follow their platform policies. Contact support for technical issues.`,
        ...
        // Performance note
        perf_note_title: "v2.2 Major Update:",
        perf_note_desc: "Video Gen Queue auto-scheduling, Project-Based Download, 4 generation modes, system logging.",
    ...
    "ja": {
        ...
        // Hero Section (v2.2)
        hero_badge: "v2.2 最新アップデート | Video Gen Queue・プロジェクトダウンロード・動画スタジオ",
        hero_title_1: "Grokを完全自動化",
        hero_title_2: "メディア資産管理",
        hero_desc: "単なるダウンローダーではなく、クリエイティブスタジオです。v2.2の新しいVideo Gen Queueで動画生成を自動スケジュール、Project-Based Downloadでファイルをプロジェクトフォルダに整理、4つの生成モードに対応。",
        hero_cta_primary: "PRO永久版を入手",
        hero_cta_secondary: "プランと料金を見る",
        hero_cta_chrome: "Chromeに追加",
        hero_trust_1: "安全・ウイルスフリー",
        hero_trust_2: "高速エンジン",

        // Video Gen Queue Section (NEW v2.2)
        queue_badge: "v2.2 新機能",
        queue_title: "Video Gen Queue",
        queue_subtitle: "自動動画生成キュー",
        queue_desc: "新しいサイドパネルインターフェースで、バッチ動画生成が可能に。Custom/Normal/Fun/Spicyモード対応、失敗時の自動リトライ、スマートなレート制限検出。",
        queue_cta: "詳しく見る",
        queue_feat_1_title: "自動リトライ",
        queue_feat_1_desc: "生成失敗時に自動的にキューに再追加し、すべてのタスクの完了を保証。",
        queue_feat_2_title: "バッチキュー追加",
        queue_feat_2_desc: "お気に入りから複数のアイテムを選択し、ワンクリックで一括キュー追加。",
        queue_feat_3_title: "4つの生成モード",
        queue_feat_3_desc: "Custom/Normal/Fun/Spicyモードで、さまざまなクリエイティブスタイルに対応。",
        queue_feat_4_title: "レート制限検出",
        queue_feat_4_desc: "Grok APIのレート制限をスマートに検出し、自動一時停止・クールダウン後に再開。",

        // Video Gen Queue Demo & Detail Page
        queue_demo_caption: "* Video Gen Queueの完全な自動化ワークフローをデモ",
        queue_page_desc: "新しいサイドパネルインターフェースで、バッチ動画生成が可能に。4つの生成モード、失敗時の自動リトライ、スマートなレート制限検出で、動画生成を完全自動化。",
        queue_video_title: "完全ワークフローデモ",
        queue_video_desc: "キューに追加 → 設定 → 自動生成 → 結果収集",
        queue_video_caption: "* 動画はVideo Gen Queueの完全なワークフローを紹介しています",
        queue_core_title: "コア機能",
        queue_core_desc: "Video Gen Queueは、完全な自動動画生成ツールチェーンを提供します",
        queue_step_title: "Video Gen Queueの使い方",
        queue_step_desc: "5つの簡単なステップで動画生成を自動化",
        queue_step_1_title: "Grok Imagineを閲覧",
        queue_step_1_desc: "grok.comで画像を閲覧・生成し、動画にしたいPostsを見つけます。",
        queue_step_2_title: "キューに追加",
        queue_step_2_desc: "フローティング🎯ボタンをクリックするか、バッチ追加で時間範囲(1h~72h)を選択してワンクリックで追加。",
        queue_step_3_title: "パラメータを設定",
        queue_step_3_desc: "モード(Custom/Normal/Fun/Spicy)、時間(6s/10s)、解像度(480p/720p)、目標回数、リトライ上限を選択。",
        queue_step_4_title: "生成開始",
        queue_step_4_desc: "Startをクリック。システムが各Postページに自動ナビゲートし、生成リクエストを順次送信。",
        queue_step_5_title: "結果を収集",
        queue_step_5_desc: "生成成功した動画はGrokのお気に入りに自動表示され、いつでもダウンロード可能。",
        queue_tech_title: "技術ハイライト",
        queue_tech_1_title: "Chrome Side Panel API",
        queue_tech_1_desc: "Chrome最新のSide Panel APIで常駐型ワークスペースを提供。メインページの閲覧を妨げません。",
        queue_tech_2_title: "IndexedDB永続化",
        queue_tech_2_desc: "キューデータとプロンプト統計をIndexedDBに独立保存。ブラウザを閉じてもデータは消えません。",
        queue_tech_3_title: "Fetch Interceptor",
        queue_tech_3_desc: "MAIN worldで生成結果をインターセプトし、90秒タイムアウトフォールバック付き。すべての生成を正確に追跡。",
        queue_tech_4_title: "Free/Proティア",
        queue_tech_4_desc: "無料ユーザーは50回、PROユーザーは無制限。異なる使用ニーズに対応。",
        queue_cta_start: "動画生成の自動化を始める",
        ...
        feat_1_desc: "手動で探す必要なし。お気に入りの画像や動画を自動スキャンし、ダウンロード可能なメディアリストを生成。",
        ...
        feat_8_title: "Video Gen Queue (PRO)",
        feat_8_desc: "自動動画生成キュー！バッチ追加、4つの生成モード、自動リトライ、レート制限検出。無料版50回、PRO無制限。",
        feat_9_title: "Project-Based Download (PRO)",
        feat_9_desc: "プロジェクトフォルダ管理！ダウンロード前の自動スキャン統計、日付とプロンプトでプロジェクトフォルダを自動作成。",
        ...
        solution_3_title: "動画制作の完全自動化",
        solution_3_desc: "v2.2 Video Gen Queueで自動スケジュール、Story Modeで編集・マージ、Project Downloadで整理整頓—オールインワン。",
        ...
        cross_link_queue: "もう一つの強力な機能を探索：Video Gen Queue →",
        cross_link_story: "もう一つの強力な機能を探索：Story Mode Helper →",
        ...
        price_feat_9: "Video Gen Queue (動画生成キュー)",
        price_feat_10: "Project-Based Download (プロジェクトフォルダ)",
        price_cta: "今すぐPROを有効化",
        price_promo_badge: "v2.2 期間限定 〜 3/10 まで",
        price_pro_button: "$4.99 → $2.99 PRO 永久版",
        ...
        faq_12_q: "Video Gen Queueとは？",
        faq_12_a: "Video Gen Queueはv2.2の新機能です。サイドパネルの自動動画生成スケジューリングシステムで、複数の動画生成タスクをバッチ追加可能。Custom/Normal/Fun/Spicyモードに対応。無料版は50回、PRO版は無制限です。",
        faq_13_q: "Project-Based Downloadとは？",
        faq_13_a: "Project-Based Downloadはダウンロード前に自動スキャンして統計情報（画像/動画数、HD/SD内訳）を表示し、日付とプロンプトでプロジェクトフォルダ（{日付}_{プロンプト}/）を自動作成します。PRO限定機能です。",
...
Lemon Squeezy購入のライセンスは同プラットフォームの規定に従う。技術的問題はサポートまで。`,
        ...
        // Performance note
        perf_note_title: "v2.2 メジャーアップデート：",
        perf_note_desc: "Video Gen Queue自動スケジュール、Project-Based Download、4つの生成モード、システムログ。",
...
if (!currentLang) {
    // Detect language from URL path — URL structure is the source of truth.
    // Do NOT use navigator.language: Googlebot uses English, which would make
    // root (zh-TW) pages render as English = duplicate of /en/ pages.
    const path = window.location.pathname;
    if (path.startsWith('/en/') || path === '/en') {
        currentLang = 'en';
    } else if (path.startsWith('/ja/') || path === '/ja') {
        currentLang = 'ja';
    } else {
        currentLang = 'zh-TW';
    }
