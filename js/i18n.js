...
const translations = {
    "zh-TW": {
        ...
        price_cta: "立即啟用 PRO",
        price_pro_button: "原價 $5.99 限時特價 $2.99 PRO 終身版 (至 1/31)",
...
透過 Lemon Squeezy 購買的授權，退款政策依循該平台規範。若遇技術問題無法解決，請聯繫支援團隊。`,
    ...
    "en": {
        ...
        price_pro_button: "Was $5.99 Now $2.99 PRO Lifetime (until 1/31)",
...
Refunds for licenses purchased via Lemon Squeezy follow their platform policies. Contact support for technical issues.`,
    ...
    "ja": {
        ...
        price_pro_button: "元価 $5.99 期間限定 $2.99 PRO 永久版 (1/31まで)",
